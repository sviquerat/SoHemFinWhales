...
RFGLS_UNCERTAINTY_DATA<-file.path(FINALDATADIR,'SORP_RF_uncertainty.RData')
...
RFGLS_RASTER_AREA_PREDICTION<-file.path(FINALDATADIR,'SORP_RFGLS_AREA:PREDICTIONS_RASTER.RData')
